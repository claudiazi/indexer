module.exports = class Data1663102393807 {
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "vote" ("id" character varying NOT NULL, "voter" text, "referendum_id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "decision" character varying(7), "balance" jsonb, "lock_period" integer, CONSTRAINT "PK_2d5932d46afe39c8176f9d4be72" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "referendum" ("id" character varying NOT NULL, "hash" text, "index" integer, "threshold" jsonb, "status" character varying(11) NOT NULL, "status_history" jsonb NOT NULL, "created_at_block" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "ended_at_block" integer, "ended_at" TIMESTAMP WITH TIME ZONE, "updated_at_block" integer, "updated_at" TIMESTAMP WITH TIME ZONE, "preimage_id" character varying, CONSTRAINT "PK_772fc260f18c235a6327252ce00" PRIMARY KEY ("id"))`)
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_9b26f67b5e37e30914cb7ca3b4"`)
