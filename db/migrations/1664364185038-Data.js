module.exports = class Data1664364185038 {
  name = 'Data1664364185038'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "question" ("id" character varying NOT NULL, "quiz_id" character varying NOT NULL, "text" text, "index_correct_answer" integer, CONSTRAINT "PK_21e5786aa0ea704ae185a79b2d5" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "quiz_submission" ("id" character varying NOT NULL, "referendum_index" integer, "block_number" integer NOT NULL, "wallet" text, "quiz_version" integer, "version" integer, "answers" integer array, "timestamp" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_af730e984e8f6f25b5667a5d7be" PRIMARY KEY ("id"))`)
