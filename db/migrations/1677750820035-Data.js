module.exports = class Data1677750820035 {
    name = 'Data1677750820035'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "distribution" ("id" character varying NOT NULL, "referendum_index" integer NOT NULL, "block_number" integer NOT NULL, "distribution_version" integer NOT NULL, "governance_version" integer NOT NULL, "wallet" text, "amount_considered" numeric NOT NULL, "index_item_received" integer, "dragon_equipped" text, "chances_at_items" numeric array, "quiz_correct" integer, "identity" integer, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_187eaf203ccf9018df51b40108c" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "quiz" ("id" character varying NOT NULL, "referendum_index" integer, "governance_version" integer, "block_number" integer NOT NULL, "creator" text, "version" integer, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_422d974e7217414e029b3e641d0" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "conviction_vote" ("id" character varying NOT NULL, "voter" text, "referendum_id" character varying NOT NULL, "referendum_index" integer NOT NULL, "block_number_voted" integer NOT NULL, "block_number_removed" integer, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "timestamp_removed" TIMESTAMP WITH TIME ZONE, "decision" character varying(12) NOT NULL, "direction" character varying(7) NOT NULL, "balance" jsonb NOT NULL, "lock_period" integer, "delegated_to" text, "type" character varying(9) NOT NULL, "is_validator" boolean, CONSTRAINT "PK_ff0112254d31eff17e0ab8f8245" PRIMARY KEY ("id"))`)
