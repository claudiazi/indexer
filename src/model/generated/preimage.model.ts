...
export class Preimage {
    ...
    @Column_("jsonb", {transformer: {to: obj => obj.map((val: any) => val.toJSON()), from: obj => obj == null ? undefined : marshal.fromList(obj, val => new PreimageStatusHistory(undefined, marshal.nonNull(val)))}, nullable: false})
